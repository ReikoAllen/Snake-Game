...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ...
        // Create a 10x10 px green square for the body
        ball = new BufferedImage(10, 10, BufferedImage.TYPE_INT_RGB);
        Graphics g = ball.getGraphics();
        g.setColor(Color.GREEN);
        g.fillRect(0, 0, 10, 10);

        // Create a 10x10 px red square for the apple
        apple = new BufferedImage(10, 10, BufferedImage.TYPE_INT_RGB);
        g = apple.getGraphics();
        g.setColor(Color.RED);
        g.fillRect(0, 0, 10, 10);

        // Create a 10x10 px blue square for the head
        head = new BufferedImage(10, 10, BufferedImage.TYPE_INT_RGB);
        g = head.getGraphics();
